...
import com.wnw.wnw.mvptest.download.DaoMaster;
import com.wnw.wnw.mvptest.download.DaoSession;
import com.wnw.wnw.mvptest.download.DownInfo;
import com.wnw.wnw.mvptest.download.DownInfoDao;
 ...
 * @author wnw
 *
 * @date 2017/10/27 0027 11:41
 *
 */

public class DbDownUtil {
    private static DbDownUtil db;
    private final static String DB_NAME = "tests_db";
